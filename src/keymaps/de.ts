...
const keymap: KeyMap = [
  ...
  ['2', 0x3],
  // evdev scancode 0x3 xkb keycode 11 xkb keyname AE02  level 2 keysym 0x22
  ['quotedbl', 0x3, 'shift'],
  ...
  ['3', 0x4],
  // evdev scancode 0x4 xkb keycode 12 xkb keyname AE03  level 2 keysym 0xa7
  ['section', 0x4, 'shift'],
  ...
  ['dollar', 0x5, 'shift'],
  // evdev scancode 0x5 xkb keycode 13 xkb keyname AE04  level 3 keysym 0xbc
  ['onequarter', 0x5, 'altgr'],
  // evdev scancode 0x5 xkb keycode 13 xkb keyname AE04  level 4 keysym 0xa4
  ['currency', 0x5, 'shift', 'altgr'],
  ...
  ['percent', 0x6, 'shift'],
  // evdev scancode 0x6 xkb keycode 14 xkb keyname AE05  level 3 keysym 0xbd
  ['onehalf', 0x6, 'altgr'],
  ...
  ['6', 0x7],
  // evdev scancode 0x7 xkb keycode 15 xkb keyname AE06  level 2 keysym 0x26
  ['ampersand', 0x7, 'shift'],
  // evdev scancode 0x7 xkb keycode 15 xkb keyname AE06  level 3 keysym 0xac
  ['notsign', 0x7, 'altgr'],
  ...
  ['7', 0x8],
  // evdev scancode 0x8 xkb keycode 16 xkb keyname AE07  level 2 keysym 0x2f
  ['slash', 0x8, 'shift'],
  // evdev scancode 0x8 xkb keycode 16 xkb keyname AE07  level 3 keysym 0x7b
  ['braceleft', 0x8, 'altgr'],
  ...
  ['8', 0x9],
  // evdev scancode 0x9 xkb keycode 17 xkb keyname AE08  level 2 keysym 0x28
  ['parenleft', 0x9, 'shift'],
  // evdev scancode 0x9 xkb keycode 17 xkb keyname AE08  level 3 keysym 0x5b
  ...
  ['9', 0xa],
  // evdev scancode 0xa xkb keycode 18 xkb keyname AE09  level 2 keysym 0x29
  ['parenright', 0xa, 'shift'],
  // evdev scancode 0xa xkb keycode 18 xkb keyname AE09  level 3 keysym 0x5d
  ...
  ['0', 0xb],
  // evdev scancode 0xb xkb keycode 19 xkb keyname AE10  level 2 keysym 0x3d
  ['equal', 0xb, 'shift'],
  // evdev scancode 0xb xkb keycode 19 xkb keyname AE10  level 3 keysym 0x7d
  ['braceright', 0xb, 'altgr'],
  // evdev scancode 0xb xkb keycode 19 xkb keyname AE10  level 4 keysym 0xb0
  ['degree', 0xb, 'shift', 'altgr'],
  // evdev scancode 0xc xkb keycode 20 xkb keyname AE11  level 1 keysym 0xdf
  ['ssharp', 0xc],
  // evdev scancode 0xc xkb keycode 20 xkb keyname AE11  level 2 keysym 0x3f
  ['question', 0xc, 'shift'],
  // evdev scancode 0xc xkb keycode 20 xkb keyname AE11  level 2 keysym 0x3f
  //['question', 0xc, 'shift', 'Lock'],
  // evdev scancode 0xc xkb keycode 20 xkb keyname AE11  level 3 keysym 0x5c
  ['backslash', 0xc, 'altgr'],
  // evdev scancode 0xc xkb keycode 20 xkb keyname AE11  level 3 keysym 0x5c
  //['backslash', 0xc, 'Lock', 'altgr'],
  // evdev scancode 0xc xkb keycode 20 xkb keyname AE11  level 4 keysym 0xbf
  ['questiondown', 0xc, 'shift', 'altgr'],
  // evdev scancode 0xc xkb keycode 20 xkb keyname AE11  level 4 keysym 0xbf
  //['questiondown', 0xc, 'shift', 'Lock', 'altgr'],
  // evdev scancode 0xc xkb keycode 20 xkb keyname AE11  level 5 keysym 0x1001e9e
  //['U1E9E', 0xc, 'Lock'],
  // evdev scancode 0xd xkb keycode 21 xkb keyname AE12  level 1 keysym 0xfe51
  ['dead_acute', 0xd],
  // evdev scancode 0xd xkb keycode 21 xkb keyname AE12  level 2 keysym 0xfe50
  ...
  // evdev scancode 0x10 xkb keycode 24 xkb keyname AD01  level 2 keysym 0x51
  //['Q', 0x10, 'Lock'],
  // evdev scancode 0x10 xkb keycode 24 xkb keyname AD01  level 3 keysym 0x40
  ['at', 0x10, 'altgr'],
  // evdev scancode 0x10 xkb keycode 24 xkb keyname AD01  level 3 keysym 0x40
  //['at', 0x10, 'Lock', 'altgr'],
  ...
  // evdev scancode 0x10 xkb keycode 24 xkb keyname AD01  level 4 keysym 0x7d9
  //['Greek_OMEGA', 0x10, 'shift', 'Lock', 'altgr'],
  ...
  // evdev scancode 0x11 xkb keycode 25 xkb keyname AD02  level 2 keysym 0x57
  //['W', 0x11, 'Lock'],
  // evdev scancode 0x11 xkb keycode 25 xkb keyname AD02  level 3 keysym 0x100017f
  ['U017F', 0x11, 'altgr'],
  // evdev scancode 0x11 xkb keycode 25 xkb keyname AD02  level 3 keysym 0x100017f
  //['U017F', 0x11, 'Lock', 'altgr'],
  // evdev scancode 0x11 xkb keycode 25 xkb keyname AD02  level 4 keysym 0xa7
  ['section', 0x11, 'shift', 'altgr'],
  // evdev scancode 0x11 xkb keycode 25 xkb keyname AD02  level 4 keysym 0xa7
  //['section', 0x11, 'shift', 'Lock', 'altgr'],
  ...
  // evdev scancode 0x12 xkb keycode 26 xkb keyname AD03  level 4 keysym 0x20ac
  ['EuroSign', 0x12, 'shift', 'altgr'],
  // evdev scancode 0x12 xkb keycode 26 xkb keyname AD03  level 4 keysym 0x20ac
  //['EuroSign', 0x12, 'shift', 'Lock', 'altgr'],
  ...
  // evdev scancode 0x15 xkb keycode 29 xkb keyname AD06  level 1 keysym 0x7a
  ['z', 0x15],
  // evdev scancode 0x15 xkb keycode 29 xkb keyname AD06  level 1 keysym 0x7a
  //['z', 0x15, 'shift', 'Lock'],
  // evdev scancode 0x15 xkb keycode 29 xkb keyname AD06  level 2 keysym 0x5a
  ['Z', 0x15, 'shift'],
  // evdev scancode 0x15 xkb keycode 29 xkb keyname AD06  level 2 keysym 0x5a
  //['Z', 0x15, 'Lock'],
  ...
  // evdev scancode 0x1a xkb keycode 34 xkb keyname AD11  level 1 keysym 0xfc
  ['udiaeresis', 0x1a],
  // evdev scancode 0x1a xkb keycode 34 xkb keyname AD11  level 1 keysym 0xfc
  //['udiaeresis', 0x1a, 'shift', 'Lock'],
  // evdev scancode 0x1a xkb keycode 34 xkb keyname AD11  level 2 keysym 0xdc
  ['Udiaeresis', 0x1a, 'shift'],
  // evdev scancode 0x1a xkb keycode 34 xkb keyname AD11  level 2 keysym 0xdc
  //['Udiaeresis', 0x1a, 'Lock'],
  // evdev scancode 0x1a xkb keycode 34 xkb keyname AD11  level 3 keysym 0xfe57
  ['dead_diaeresis', 0x1a, 'altgr'],
  // evdev scancode 0x1a xkb keycode 34 xkb keyname AD11  level 3 keysym 0xfe57
  //['dead_diaeresis', 0x1a, 'Lock', 'altgr'],
  // evdev scancode 0x1a xkb keycode 34 xkb keyname AD11  level 4 keysym 0xfe58
  ['dead_abovering', 0x1a, 'shift', 'altgr'],
  // evdev scancode 0x1a xkb keycode 34 xkb keyname AD11  level 4 keysym 0xfe58
  //['dead_abovering', 0x1a, 'shift', 'Lock', 'altgr'],
  // evdev scancode 0x1b xkb keycode 35 xkb keyname AD12  level 1 keysym 0x2b
  ['plus', 0x1b],
  // evdev scancode 0x1b xkb keycode 35 xkb keyname AD12  level 2 keysym 0x2a
  ['asterisk', 0x1b, 'shift'],
  // evdev scancode 0x1b xkb keycode 35 xkb keyname AD12  level 3 keysym 0x7e
  ['asciitilde', 0x1b, 'altgr'],
  // evdev scancode 0x1b xkb keycode 35 xkb keyname AD12  level 4 keysym 0xaf
  ...
  // evdev scancode 0x1e xkb keycode 38 xkb keyname AC01  level 2 keysym 0x41
  //['A', 0x1e, 'Lock'],
  // evdev scancode 0x1e xkb keycode 38 xkb keyname AC01  level 3 keysym 0xe6
  ['ae', 0x1e, 'altgr'],
  // evdev scancode 0x1e xkb keycode 38 xkb keyname AC01  level 3 keysym 0xe6
  //['ae', 0x1e, 'shift', 'Lock', 'altgr'],
  // evdev scancode 0x1e xkb keycode 38 xkb keyname AC01  level 4 keysym 0xc6
  ['AE', 0x1e, 'shift', 'altgr'],
  // evdev scancode 0x1e xkb keycode 38 xkb keyname AC01  level 4 keysym 0xc6
  //['AE', 0x1e, 'Lock', 'altgr'],
  ...
  // evdev scancode 0x1f xkb keycode 39 xkb keyname AC02  level 2 keysym 0x53
  //['S', 0x1f, 'Lock'],
  // evdev scancode 0x1f xkb keycode 39 xkb keyname AC02  level 3 keysym 0x100017f
  ['U017F', 0x1f, 'altgr'],
  // evdev scancode 0x1f xkb keycode 39 xkb keyname AC02  level 3 keysym 0x100017f
  //['U017F', 0x1f, 'shift', 'Lock', 'altgr'],
  ...
  // evdev scancode 0x24 xkb keycode 44 xkb keyname AC07  level 2 keysym 0x4a
  //['J', 0x24, 'Lock'],
  // evdev scancode 0x24 xkb keycode 44 xkb keyname AC07  level 3 keysym 0xfe60
  ['dead_belowdot', 0x24, 'altgr'],
  // evdev scancode 0x24 xkb keycode 44 xkb keyname AC07  level 3 keysym 0xfe60
  //['dead_belowdot', 0x24, 'Lock', 'altgr'],
  // evdev scancode 0x24 xkb keycode 44 xkb keyname AC07  level 4 keysym 0xfe56
  ['dead_abovedot', 0x24, 'shift', 'altgr'],
  // evdev scancode 0x24 xkb keycode 44 xkb keyname AC07  level 4 keysym 0xfe56
  //['dead_abovedot', 0x24, 'shift', 'Lock', 'altgr'],
  ...
  // evdev scancode 0x27 xkb keycode 47 xkb keyname AC10  level 1 keysym 0xf6
  ['odiaeresis', 0x27],
  // evdev scancode 0x27 xkb keycode 47 xkb keyname AC10  level 1 keysym 0xf6
  //['odiaeresis', 0x27, 'shift', 'Lock'],
  // evdev scancode 0x27 xkb keycode 47 xkb keyname AC10  level 2 keysym 0xd6
  ['Odiaeresis', 0x27, 'shift'],
  // evdev scancode 0x27 xkb keycode 47 xkb keyname AC10  level 2 keysym 0xd6
  //['Odiaeresis', 0x27, 'Lock'],
  // evdev scancode 0x27 xkb keycode 47 xkb keyname AC10  level 3 keysym 0xfe59
  ['dead_doubleacute', 0x27, 'altgr'],
  // evdev scancode 0x27 xkb keycode 47 xkb keyname AC10  level 3 keysym 0xfe59
  //['dead_doubleacute', 0x27, 'Lock', 'altgr'],
  // evdev scancode 0x27 xkb keycode 47 xkb keyname AC10  level 4 keysym 0xfe60
  ['dead_belowdot', 0x27, 'shift', 'altgr'],
  // evdev scancode 0x27 xkb keycode 47 xkb keyname AC10  level 4 keysym 0xfe60
  //['dead_belowdot', 0x27, 'shift', 'Lock', 'altgr'],
  // evdev scancode 0x28 xkb keycode 48 xkb keyname AC11  level 1 keysym 0xe4
  ['adiaeresis', 0x28],
  // evdev scancode 0x28 xkb keycode 48 xkb keyname AC11  level 1 keysym 0xe4
  //['adiaeresis', 0x28, 'shift', 'Lock'],
  // evdev scancode 0x28 xkb keycode 48 xkb keyname AC11  level 2 keysym 0xc4
  ['Adiaeresis', 0x28, 'shift'],
  // evdev scancode 0x28 xkb keycode 48 xkb keyname AC11  level 2 keysym 0xc4
  //['Adiaeresis', 0x28, 'Lock'],
  // evdev scancode 0x28 xkb keycode 48 xkb keyname AC11  level 3 keysym 0xfe52
  ['dead_circumflex', 0x28, 'altgr'],
  // evdev scancode 0x28 xkb keycode 48 xkb keyname AC11  level 3 keysym 0xfe52
  //['dead_circumflex', 0x28, 'Lock', 'altgr'],
  // evdev scancode 0x28 xkb keycode 48 xkb keyname AC11  level 4 keysym 0xfe5a
  ['dead_caron', 0x28, 'shift', 'altgr'],
  // evdev scancode 0x28 xkb keycode 48 xkb keyname AC11  level 4 keysym 0xfe5a
  //['dead_caron', 0x28, 'shift', 'Lock', 'altgr'],
  // evdev scancode 0x29 xkb keycode 49 xkb keyname TLDE  level 1 keysym 0xfe52
  ['dead_circumflex', 0x29],
  // evdev scancode 0x29 xkb keycode 49 xkb keyname TLDE  level 2 keysym 0xb0
  ['degree', 0x29, 'shift'],
  // evdev scancode 0x29 xkb keycode 49 xkb keyname TLDE  level 3 keysym 0x1002032
  ['U2032', 0x29, 'altgr'],
  // evdev scancode 0x29 xkb keycode 49 xkb keyname TLDE  level 4 keysym 0x1002033
  ['U2033', 0x29, 'shift', 'altgr'],
  // evdev scancode 0x2a xkb keycode 50 xkb keyname LFSH  level 1 keysym 0xffe1
  ['shift_L', 0x2a],
  // evdev scancode 0x2b xkb keycode 51 xkb keyname BKSL  level 1 keysym 0x23
  ['numbersign', 0x2b],
  // evdev scancode 0x2b xkb keycode 51 xkb keyname BKSL  level 2 keysym 0x27
  ['apostrophe', 0x2b, 'shift'],
  // evdev scancode 0x2b xkb keycode 51 xkb keyname BKSL  level 3 keysym 0xad1
  ...
  // evdev scancode 0x2c xkb keycode 52 xkb keyname AB01  level 1 keysym 0x79
  ['y', 0x2c],
  // evdev scancode 0x2c xkb keycode 52 xkb keyname AB01  level 1 keysym 0x79
  //['y', 0x2c, 'shift', 'Lock'],
  // evdev scancode 0x2c xkb keycode 52 xkb keyname AB01  level 2 keysym 0x59
  ['Y', 0x2c, 'shift'],
  // evdev scancode 0x2c xkb keycode 52 xkb keyname AB01  level 2 keysym 0x59
  //['Y', 0x2c, 'Lock'],
  // evdev scancode 0x2c xkb keycode 52 xkb keyname AB01  level 3 keysym 0xbb
  ['guillemotright', 0x2c, 'altgr'],
  // evdev scancode 0x2c xkb keycode 52 xkb keyname AB01  level 3 keysym 0xbb
  //['guillemotright', 0x2c, 'Lock', 'altgr'],
  // evdev scancode 0x2c xkb keycode 52 xkb keyname AB01  level 4 keysym 0x100203a
  ['U203A', 0x2c, 'shift', 'altgr'],
  // evdev scancode 0x2c xkb keycode 52 xkb keyname AB01  level 4 keysym 0x100203a
  //['U203A', 0x2c, 'shift', 'Lock', 'altgr'],
  ...
  // evdev scancode 0x2d xkb keycode 53 xkb keyname AB02  level 2 keysym 0x58
  //['X', 0x2d, 'Lock'],
  // evdev scancode 0x2d xkb keycode 53 xkb keyname AB02  level 3 keysym 0xab
  ['guillemotleft', 0x2d, 'altgr'],
  // evdev scancode 0x2d xkb keycode 53 xkb keyname AB02  level 3 keysym 0xab
  //['guillemotleft', 0x2d, 'Lock', 'altgr'],
  // evdev scancode 0x2d xkb keycode 53 xkb keyname AB02  level 4 keysym 0x1002039
  ['U2039', 0x2d, 'shift', 'altgr'],
  // evdev scancode 0x2d xkb keycode 53 xkb keyname AB02  level 4 keysym 0x1002039
  //['U2039', 0x2d, 'shift', 'Lock', 'altgr'],
  ...
  // evdev scancode 0x32 xkb keycode 58 xkb keyname AB07  level 3 keysym 0xb5
  //['mu', 0x32, 'Lock', 'altgr'],
  // evdev scancode 0x32 xkb keycode 58 xkb keyname AB07  level 4 keysym 0xba
  ['masculine', 0x32, 'shift', 'altgr'],
  // evdev scancode 0x32 xkb keycode 58 xkb keyname AB07  level 4 keysym 0xba
  //['masculine', 0x32, 'shift', 'Lock', 'altgr'],
  // evdev scancode 0x33 xkb keycode 59 xkb keyname AB08  level 1 keysym 0x2c
  ['comma', 0x33],
  // evdev scancode 0x33 xkb keycode 59 xkb keyname AB08  level 2 keysym 0x3b
  ['semicolon', 0x33, 'shift'],
  // evdev scancode 0x33 xkb keycode 59 xkb keyname AB08  level 3 keysym 0xb7
  ...
  ['period', 0x34],
  // evdev scancode 0x34 xkb keycode 60 xkb keyname AB09  level 2 keysym 0x3a
  ['colon', 0x34, 'shift'],
  // evdev scancode 0x34 xkb keycode 60 xkb keyname AB09  level 3 keysym 0x1002026
  ['U2026', 0x34, 'altgr'],
  // evdev scancode 0x34 xkb keycode 60 xkb keyname AB09  level 4 keysym 0xf7
  ['division', 0x34, 'shift', 'altgr'],
  // evdev scancode 0x35 xkb keycode 61 xkb keyname AB10  level 1 keysym 0x2d
  ['minus', 0x35],
  // evdev scancode 0x35 xkb keycode 61 xkb keyname AB10  level 2 keysym 0x5f
  ['underscore', 0x35, 'shift'],
  // evdev scancode 0x35 xkb keycode 61 xkb keyname AB10  level 3 keysym 0xaaa
  ['endash', 0x35, 'altgr'],
  // evdev scancode 0x35 xkb keycode 61 xkb keyname AB10  level 4 keysym 0xaa9
  ...
  ['bar', 0x56, 'altgr'],
  // evdev scancode 0x56 xkb keycode 94 xkb keyname LSGT  level 4 keysym 0xfe68
