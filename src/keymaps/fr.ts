...
const keymap: KeyMap = [
  ...
  ['Escape', 0x1],
  // evdev scancode 0x2 xkb keycode 10 xkb keyname AE01  level 1 keysym 0x26
  ['ampersand', 0x2],
  // evdev scancode 0x2 xkb keycode 10 xkb keyname AE01  level 2 keysym 0x31
  ['1', 0x2, 'shift'],
  // evdev scancode 0x2 xkb keycode 10 xkb keyname AE01  level 3 keysym 0xb9
  ['onesuperior', 0x2, 'altgr'],
  // evdev scancode 0x2 xkb keycode 10 xkb keyname AE01  level 4 keysym 0xa1
  ['exclamdown', 0x2, 'shift', 'altgr'],
  // evdev scancode 0x3 xkb keycode 11 xkb keyname AE02  level 1 keysym 0xe9
  ['eacute', 0x3],
  // evdev scancode 0x3 xkb keycode 11 xkb keyname AE02  level 2 keysym 0x32
  ['2', 0x3, 'shift'],
  // evdev scancode 0x3 xkb keycode 11 xkb keyname AE02  level 3 keysym 0x7e
  ['asciitilde', 0x3, 'altgr'],
  // evdev scancode 0x3 xkb keycode 11 xkb keyname AE02  level 4 keysym 0xac3
  ['oneeighth', 0x3, 'shift', 'altgr'],
  // evdev scancode 0x4 xkb keycode 12 xkb keyname AE03  level 1 keysym 0x22
  ['quotedbl', 0x4],
  // evdev scancode 0x4 xkb keycode 12 xkb keyname AE03  level 2 keysym 0x33
  ['3', 0x4, 'shift'],
  // evdev scancode 0x4 xkb keycode 12 xkb keyname AE03  level 3 keysym 0x23
  ['numbersign', 0x4, 'altgr'],
  // evdev scancode 0x4 xkb keycode 12 xkb keyname AE03  level 4 keysym 0xa3
  ['sterling', 0x4, 'shift', 'altgr'],
  // evdev scancode 0x5 xkb keycode 13 xkb keyname AE04  level 1 keysym 0x27
  ['apostrophe', 0x5],
  // evdev scancode 0x5 xkb keycode 13 xkb keyname AE04  level 2 keysym 0x34
  ['4', 0x5, 'shift'],
  // evdev scancode 0x5 xkb keycode 13 xkb keyname AE04  level 3 keysym 0x7b
  ['braceleft', 0x5, 'altgr'],
  // evdev scancode 0x5 xkb keycode 13 xkb keyname AE04  level 4 keysym 0x24
  ['dollar', 0x5, 'shift', 'altgr'],
  // evdev scancode 0x6 xkb keycode 14 xkb keyname AE05  level 1 keysym 0x28
  ['parenleft', 0x6],
  // evdev scancode 0x6 xkb keycode 14 xkb keyname AE05  level 2 keysym 0x35
  ['5', 0x6, 'shift'],
  // evdev scancode 0x6 xkb keycode 14 xkb keyname AE05  level 3 keysym 0x5b
  ['bracketleft', 0x6, 'altgr'],
  // evdev scancode 0x6 xkb keycode 14 xkb keyname AE05  level 4 keysym 0xac4
  ['threeeighths', 0x6, 'shift', 'altgr'],
  // evdev scancode 0x7 xkb keycode 15 xkb keyname AE06  level 1 keysym 0x2d
  ['minus', 0x7],
  // evdev scancode 0x7 xkb keycode 15 xkb keyname AE06  level 2 keysym 0x36
  ['6', 0x7, 'shift'],
  // evdev scancode 0x7 xkb keycode 15 xkb keyname AE06  level 3 keysym 0x7c
  ['bar', 0x7, 'altgr'],
  // evdev scancode 0x7 xkb keycode 15 xkb keyname AE06  level 4 keysym 0xac5
  ['fiveeighths', 0x7, 'shift', 'altgr'],
  // evdev scancode 0x8 xkb keycode 16 xkb keyname AE07  level 1 keysym 0xe8
  ['egrave', 0x8],
  // evdev scancode 0x8 xkb keycode 16 xkb keyname AE07  level 2 keysym 0x37
  ['7', 0x8, 'shift'],
  // evdev scancode 0x8 xkb keycode 16 xkb keyname AE07  level 3 keysym 0x60
  ['grave', 0x8, 'altgr'],
  // evdev scancode 0x8 xkb keycode 16 xkb keyname AE07  level 4 keysym 0xac6
  ['seveneighths', 0x8, 'shift', 'altgr'],
  // evdev scancode 0x9 xkb keycode 17 xkb keyname AE08  level 1 keysym 0x5f
  ['underscore', 0x9],
  // evdev scancode 0x9 xkb keycode 17 xkb keyname AE08  level 2 keysym 0x38
  ['8', 0x9, 'shift'],
  // evdev scancode 0x9 xkb keycode 17 xkb keyname AE08  level 3 keysym 0x5c
  ['backslash', 0x9, 'altgr'],
  // evdev scancode 0x9 xkb keycode 17 xkb keyname AE08  level 4 keysym 0xac9
  ['trademark', 0x9, 'shift', 'altgr'],
  // evdev scancode 0xa xkb keycode 18 xkb keyname AE09  level 1 keysym 0xe7
  ['ccedilla', 0xa],
  // evdev scancode 0xa xkb keycode 18 xkb keyname AE09  level 2 keysym 0x39
  ['9', 0xa, 'shift'],
  // evdev scancode 0xa xkb keycode 18 xkb keyname AE09  level 3 keysym 0x5e
  ['asciicircum', 0xa, 'altgr'],
  // evdev scancode 0xa xkb keycode 18 xkb keyname AE09  level 4 keysym 0xb1
  ['plusminus', 0xa, 'shift', 'altgr'],
  // evdev scancode 0xb xkb keycode 19 xkb keyname AE10  level 1 keysym 0xe0
  ['agrave', 0xb],
  // evdev scancode 0xb xkb keycode 19 xkb keyname AE10  level 2 keysym 0x30
  ['0', 0xb, 'shift'],
  // evdev scancode 0xb xkb keycode 19 xkb keyname AE10  level 3 keysym 0x40
  ['at', 0xb, 'altgr'],
  // evdev scancode 0xb xkb keycode 19 xkb keyname AE10  level 4 keysym 0xb0
  ['degree', 0xb, 'shift', 'altgr'],
  // evdev scancode 0xc xkb keycode 20 xkb keyname AE11  level 1 keysym 0x29
  ['parenright', 0xc],
  // evdev scancode 0xc xkb keycode 20 xkb keyname AE11  level 2 keysym 0xb0
  ['degree', 0xc, 'shift'],
  // evdev scancode 0xc xkb keycode 20 xkb keyname AE11  level 3 keysym 0x5d
  ['bracketright', 0xc, 'altgr'],
  // evdev scancode 0xc xkb keycode 20 xkb keyname AE11  level 4 keysym 0xbf
  ...
  ['plus', 0xd, 'shift'],
  // evdev scancode 0xd xkb keycode 21 xkb keyname AE12  level 3 keysym 0x7d
  ['braceright', 0xd, 'altgr'],
  ...
  // evdev scancode 0x10 xkb keycode 24 xkb keyname AD01  level 1 keysym 0x61
  ['a', 0x10],
  // evdev scancode 0x10 xkb keycode 24 xkb keyname AD01  level 1 keysym 0x61
  //['a', 0x10, 'shift', 'Lock'],
  // evdev scancode 0x10 xkb keycode 24 xkb keyname AD01  level 2 keysym 0x41
  ['A', 0x10, 'shift'],
  // evdev scancode 0x10 xkb keycode 24 xkb keyname AD01  level 2 keysym 0x41
  //['A', 0x10, 'Lock'],
  // evdev scancode 0x10 xkb keycode 24 xkb keyname AD01  level 3 keysym 0xe6
  ['ae', 0x10, 'altgr'],
  // evdev scancode 0x10 xkb keycode 24 xkb keyname AD01  level 3 keysym 0xe6
  //['ae', 0x10, 'shift', 'Lock', 'altgr'],
  // evdev scancode 0x10 xkb keycode 24 xkb keyname AD01  level 4 keysym 0xc6
  ['AE', 0x10, 'shift', 'altgr'],
  // evdev scancode 0x10 xkb keycode 24 xkb keyname AD01  level 4 keysym 0xc6
  //['AE', 0x10, 'Lock', 'altgr'],
  // evdev scancode 0x11 xkb keycode 25 xkb keyname AD02  level 1 keysym 0x7a
  ['z', 0x11],
  // evdev scancode 0x11 xkb keycode 25 xkb keyname AD02  level 1 keysym 0x7a
  //['z', 0x11, 'shift', 'Lock'],
  // evdev scancode 0x11 xkb keycode 25 xkb keyname AD02  level 2 keysym 0x5a
  ['Z', 0x11, 'shift'],
  // evdev scancode 0x11 xkb keycode 25 xkb keyname AD02  level 2 keysym 0x5a
  //['Z', 0x11, 'Lock'],
  // evdev scancode 0x11 xkb keycode 25 xkb keyname AD02  level 3 keysym 0xab
  ['guillemotleft', 0x11, 'altgr'],
  // evdev scancode 0x11 xkb keycode 25 xkb keyname AD02  level 3 keysym 0xab
  //['guillemotleft', 0x11, 'Lock', 'altgr'],
  // evdev scancode 0x11 xkb keycode 25 xkb keyname AD02  level 4 keysym 0x3c
  ['less', 0x11, 'shift', 'altgr'],
  // evdev scancode 0x11 xkb keycode 25 xkb keyname AD02  level 4 keysym 0x3c
  //['less', 0x11, 'shift', 'Lock', 'altgr'],
  ...
  // evdev scancode 0x12 xkb keycode 26 xkb keyname AD03  level 2 keysym 0x45
  //['E', 0x12, 'Lock'],
  // evdev scancode 0x12 xkb keycode 26 xkb keyname AD03  level 3 keysym 0x20ac
  ['EuroSign', 0x12, 'altgr'],
  // evdev scancode 0x12 xkb keycode 26 xkb keyname AD03  level 3 keysym 0x20ac
  //['EuroSign', 0x12, 'Lock', 'altgr'],
  // evdev scancode 0x12 xkb keycode 26 xkb keyname AD03  level 4 keysym 0xa2
  ['cent', 0x12, 'shift', 'altgr'],
  // evdev scancode 0x12 xkb keycode 26 xkb keyname AD03  level 4 keysym 0xa2
  //['cent', 0x12, 'shift', 'Lock', 'altgr'],
  ...
  // evdev scancode 0x13 xkb keycode 27 xkb keyname AD04  level 2 keysym 0x52
  //['R', 0x13, 'Lock'],
  // evdev scancode 0x13 xkb keycode 27 xkb keyname AD04  level 3 keysym 0xb6
  ['paragraph', 0x13, 'altgr'],
  // evdev scancode 0x13 xkb keycode 27 xkb keyname AD04  level 3 keysym 0xb6
  //['paragraph', 0x13, 'Lock', 'altgr'],
  ...
  // evdev scancode 0x14 xkb keycode 28 xkb keyname AD05  level 2 keysym 0x54
  //['T', 0x14, 'Lock'],
  // evdev scancode 0x14 xkb keycode 28 xkb keyname AD05  level 3 keysym 0x3bc
  ['tslash', 0x14, 'altgr'],
  // evdev scancode 0x14 xkb keycode 28 xkb keyname AD05  level 3 keysym 0x3bc
  //['tslash', 0x14, 'shift', 'Lock', 'altgr'],
  // evdev scancode 0x14 xkb keycode 28 xkb keyname AD05  level 4 keysym 0x3ac
  ['Tslash', 0x14, 'shift', 'altgr'],
  // evdev scancode 0x14 xkb keycode 28 xkb keyname AD05  level 4 keysym 0x3ac
  //['Tslash', 0x14, 'Lock', 'altgr'],
  ...
  // evdev scancode 0x17 xkb keycode 31 xkb keyname AD08  level 4 keysym 0x2b9
  ['idotless', 0x17, 'shift', 'altgr'],
  // evdev scancode 0x17 xkb keycode 31 xkb keyname AD08  level 4 keysym 0x2b9
  //['idotless', 0x17, 'shift', 'Lock', 'altgr'],
  ...
  // evdev scancode 0x18 xkb keycode 32 xkb keyname AD09  level 2 keysym 0x4f
  //['O', 0x18, 'Lock'],
  // evdev scancode 0x18 xkb keycode 32 xkb keyname AD09  level 3 keysym 0xf8
  ['oslash', 0x18, 'altgr'],
  // evdev scancode 0x18 xkb keycode 32 xkb keyname AD09  level 3 keysym 0xf8
  //['oslash', 0x18, 'shift', 'Lock', 'altgr'],
  // evdev scancode 0x18 xkb keycode 32 xkb keyname AD09  level 4 keysym 0xd8
  ['Oslash', 0x18, 'shift', 'altgr'],
  // evdev scancode 0x18 xkb keycode 32 xkb keyname AD09  level 4 keysym 0xd8
  //['Oslash', 0x18, 'Lock', 'altgr'],
  ...
  // evdev scancode 0x1a xkb keycode 34 xkb keyname AD11  level 1 keysym 0xfe52
  ['dead_circumflex', 0x1a],
  // evdev scancode 0x1a xkb keycode 34 xkb keyname AD11  level 2 keysym 0xfe57
  ...
  // evdev scancode 0x1b xkb keycode 35 xkb keyname AD12  level 1 keysym 0x24
  ['dollar', 0x1b],
  // evdev scancode 0x1b xkb keycode 35 xkb keyname AD12  level 2 keysym 0xa3
  ['sterling', 0x1b, 'shift'],
  // evdev scancode 0x1b xkb keycode 35 xkb keyname AD12  level 3 keysym 0xa4
  ['currency', 0x1b, 'altgr'],
  ...
  ['control_L', 0x1d],
  // evdev scancode 0x1e xkb keycode 38 xkb keyname AC01  level 1 keysym 0x71
  ['q', 0x1e],
  // evdev scancode 0x1e xkb keycode 38 xkb keyname AC01  level 1 keysym 0x71
  //['q', 0x1e, 'shift', 'Lock'],
  // evdev scancode 0x1e xkb keycode 38 xkb keyname AC01  level 2 keysym 0x51
  ['Q', 0x1e, 'shift'],
  // evdev scancode 0x1e xkb keycode 38 xkb keyname AC01  level 2 keysym 0x51
  //['Q', 0x1e, 'Lock'],
  // evdev scancode 0x1e xkb keycode 38 xkb keyname AC01  level 3 keysym 0x40
  ['at', 0x1e, 'altgr'],
  // evdev scancode 0x1e xkb keycode 38 xkb keyname AC01  level 3 keysym 0x40
  //['at', 0x1e, 'Lock', 'altgr'],
  // evdev scancode 0x1e xkb keycode 38 xkb keyname AC01  level 4 keysym 0x7d9
  ['Greek_OMEGA', 0x1e, 'shift', 'altgr'],
  // evdev scancode 0x1e xkb keycode 38 xkb keyname AC01  level 4 keysym 0x7d9
  //['Greek_OMEGA', 0x1e, 'shift', 'Lock', 'altgr'],
  ...
  // evdev scancode 0x1f xkb keycode 39 xkb keyname AC02  level 2 keysym 0x53
  //['S', 0x1f, 'Lock'],
  // evdev scancode 0x1f xkb keycode 39 xkb keyname AC02  level 3 keysym 0xdf
  ['ssharp', 0x1f, 'altgr'],
  // evdev scancode 0x1f xkb keycode 39 xkb keyname AC02  level 3 keysym 0xdf
  //['ssharp', 0x1f, 'shift', 'Lock', 'altgr'],
  // evdev scancode 0x1f xkb keycode 39 xkb keyname AC02  level 4 keysym 0x1001e9e
  ['U1E9E', 0x1f, 'shift', 'altgr'],
  // evdev scancode 0x1f xkb keycode 39 xkb keyname AC02  level 4 keysym 0x1001e9e
  //['U1E9E', 0x1f, 'Lock', 'altgr'],
  ...
  // evdev scancode 0x21 xkb keycode 41 xkb keyname AC04  level 2 keysym 0x46
  //['F', 0x21, 'Lock'],
  // evdev scancode 0x21 xkb keycode 41 xkb keyname AC04  level 3 keysym 0x1f0
  ['dstroke', 0x21, 'altgr'],
  // evdev scancode 0x21 xkb keycode 41 xkb keyname AC04  level 3 keysym 0x1f0
  //['dstroke', 0x21, 'Lock', 'altgr'],
  // evdev scancode 0x21 xkb keycode 41 xkb keyname AC04  level 4 keysym 0xaa
  ['ordfeminine', 0x21, 'shift', 'altgr'],
  // evdev scancode 0x21 xkb keycode 41 xkb keyname AC04  level 4 keysym 0xaa
  //['ordfeminine', 0x21, 'shift', 'Lock', 'altgr'],
  ...
  // evdev scancode 0x23 xkb keycode 43 xkb keyname AC06  level 2 keysym 0x48
  //['H', 0x23, 'Lock'],
  // evdev scancode 0x23 xkb keycode 43 xkb keyname AC06  level 3 keysym 0x2b1
  ['hstroke', 0x23, 'altgr'],
  // evdev scancode 0x23 xkb keycode 43 xkb keyname AC06  level 3 keysym 0x2b1
  //['hstroke', 0x23, 'shift', 'Lock', 'altgr'],
  // evdev scancode 0x23 xkb keycode 43 xkb keyname AC06  level 4 keysym 0x2a1
  ['Hstroke', 0x23, 'shift', 'altgr'],
  // evdev scancode 0x23 xkb keycode 43 xkb keyname AC06  level 4 keysym 0x2a1
  //['Hstroke', 0x23, 'Lock', 'altgr'],
  ...
  // evdev scancode 0x24 xkb keycode 44 xkb keyname AC07  level 2 keysym 0x4a
  //['J', 0x24, 'Lock'],
  // evdev scancode 0x24 xkb keycode 44 xkb keyname AC07  level 3 keysym 0xfe61
  ['dead_hook', 0x24, 'altgr'],
  // evdev scancode 0x24 xkb keycode 44 xkb keyname AC07  level 3 keysym 0xfe61
  //['dead_hook', 0x24, 'Lock', 'altgr'],
  // evdev scancode 0x24 xkb keycode 44 xkb keyname AC07  level 4 keysym 0xfe62
  ['dead_horn', 0x24, 'shift', 'altgr'],
  // evdev scancode 0x24 xkb keycode 44 xkb keyname AC07  level 4 keysym 0xfe62
  //['dead_horn', 0x24, 'shift', 'Lock', 'altgr'],
  ...
  // evdev scancode 0x25 xkb keycode 45 xkb keyname AC08  level 2 keysym 0x4b
  //['K', 0x25, 'Lock'],
  // evdev scancode 0x25 xkb keycode 45 xkb keyname AC08  level 3 keysym 0x3a2
  ['kra', 0x25, 'altgr'],
  // evdev scancode 0x25 xkb keycode 45 xkb keyname AC08  level 3 keysym 0x3a2
  //['kra', 0x25, 'Lock', 'altgr'],
  // evdev scancode 0x25 xkb keycode 45 xkb keyname AC08  level 4 keysym 0x26
  ['ampersand', 0x25, 'shift', 'altgr'],
  // evdev scancode 0x25 xkb keycode 45 xkb keyname AC08  level 4 keysym 0x26
  //['ampersand', 0x25, 'shift', 'Lock', 'altgr'],
  ...
  // evdev scancode 0x27 xkb keycode 47 xkb keyname AC10  level 1 keysym 0x6d
  ['m', 0x27],
  // evdev scancode 0x27 xkb keycode 47 xkb keyname AC10  level 1 keysym 0x6d
  //['m', 0x27, 'shift', 'Lock'],
  // evdev scancode 0x27 xkb keycode 47 xkb keyname AC10  level 2 keysym 0x4d
  ['M', 0x27, 'shift'],
  // evdev scancode 0x27 xkb keycode 47 xkb keyname AC10  level 2 keysym 0x4d
  //['M', 0x27, 'Lock'],
  // evdev scancode 0x27 xkb keycode 47 xkb keyname AC10  level 3 keysym 0xb5
  ['mu', 0x27, 'altgr'],
  // evdev scancode 0x27 xkb keycode 47 xkb keyname AC10  level 3 keysym 0xb5
  //['mu', 0x27, 'Lock', 'altgr'],
  // evdev scancode 0x27 xkb keycode 47 xkb keyname AC10  level 4 keysym 0xba
  ['masculine', 0x27, 'shift', 'altgr'],
  // evdev scancode 0x27 xkb keycode 47 xkb keyname AC10  level 4 keysym 0xba
  //['masculine', 0x27, 'shift', 'Lock', 'altgr'],
  // evdev scancode 0x28 xkb keycode 48 xkb keyname AC11  level 1 keysym 0xf9
  ['ugrave', 0x28],
  // evdev scancode 0x28 xkb keycode 48 xkb keyname AC11  level 2 keysym 0x25
  ['percent', 0x28, 'shift'],
  ...
  // evdev scancode 0x29 xkb keycode 49 xkb keyname TLDE  level 1 keysym 0xb2
  ['twosuperior', 0x29],
  ...
  ['notsign', 0x29, 'altgr'],
  // evdev scancode 0x29 xkb keycode 49 xkb keyname TLDE  level 4 keysym 0xac
  ['notsign', 0x29, 'shift', 'altgr'],
  // evdev scancode 0x2a xkb keycode 50 xkb keyname LFSH  level 1 keysym 0xffe1
  ['shift_L', 0x2a],
  // evdev scancode 0x2b xkb keycode 51 xkb keyname BKSL  level 1 keysym 0x2a
  ['asterisk', 0x2b],
  // evdev scancode 0x2b xkb keycode 51 xkb keyname BKSL  level 2 keysym 0xb5
  ['mu', 0x2b, 'shift'],
  ...
  // evdev scancode 0x2c xkb keycode 52 xkb keyname AB01  level 1 keysym 0x77
  ['w', 0x2c],
  // evdev scancode 0x2c xkb keycode 52 xkb keyname AB01  level 1 keysym 0x77
  //['w', 0x2c, 'shift', 'Lock'],
  // evdev scancode 0x2c xkb keycode 52 xkb keyname AB01  level 2 keysym 0x57
  ['W', 0x2c, 'shift'],
  // evdev scancode 0x2c xkb keycode 52 xkb keyname AB01  level 2 keysym 0x57
  //['W', 0x2c, 'Lock'],
  // evdev scancode 0x2c xkb keycode 52 xkb keyname AB01  level 3 keysym 0x1b3
  ['lstroke', 0x2c, 'altgr'],
  // evdev scancode 0x2c xkb keycode 52 xkb keyname AB01  level 3 keysym 0x1b3
  //['lstroke', 0x2c, 'shift', 'Lock', 'altgr'],
  // evdev scancode 0x2c xkb keycode 52 xkb keyname AB01  level 4 keysym 0x1a3
  ['Lstroke', 0x2c, 'shift', 'altgr'],
  // evdev scancode 0x2c xkb keycode 52 xkb keyname AB01  level 4 keysym 0x1a3
  //['Lstroke', 0x2c, 'Lock', 'altgr'],
  ...
  // evdev scancode 0x2d xkb keycode 53 xkb keyname AB02  level 2 keysym 0x58
  //['X', 0x2d, 'Lock'],
  // evdev scancode 0x2d xkb keycode 53 xkb keyname AB02  level 3 keysym 0xbb
  ['guillemotright', 0x2d, 'altgr'],
  // evdev scancode 0x2d xkb keycode 53 xkb keyname AB02  level 3 keysym 0xbb
  //['guillemotright', 0x2d, 'Lock', 'altgr'],
  // evdev scancode 0x2d xkb keycode 53 xkb keyname AB02  level 4 keysym 0x3e
  ['greater', 0x2d, 'shift', 'altgr'],
  // evdev scancode 0x2d xkb keycode 53 xkb keyname AB02  level 4 keysym 0x3e
  //['greater', 0x2d, 'shift', 'Lock', 'altgr'],
  ...
  // evdev scancode 0x2e xkb keycode 54 xkb keyname AB03  level 2 keysym 0x43
  //['C', 0x2e, 'Lock'],
  // evdev scancode 0x2e xkb keycode 54 xkb keyname AB03  level 3 keysym 0xa2
  ['cent', 0x2e, 'altgr'],
  // evdev scancode 0x2e xkb keycode 54 xkb keyname AB03  level 3 keysym 0xa2
  //['cent', 0x2e, 'Lock', 'altgr'],
  // evdev scancode 0x2e xkb keycode 54 xkb keyname AB03  level 4 keysym 0xa9
  ['copyright', 0x2e, 'shift', 'altgr'],
  // evdev scancode 0x2e xkb keycode 54 xkb keyname AB03  level 4 keysym 0xa9
  //['copyright', 0x2e, 'shift', 'Lock', 'altgr'],
  ...
  // evdev scancode 0x2f xkb keycode 55 xkb keyname AB04  level 4 keysym 0xafd
  ['singlelowquotemark', 0x2f, 'shift', 'altgr'],
  // evdev scancode 0x2f xkb keycode 55 xkb keyname AB04  level 4 keysym 0xafd
  //['singlelowquotemark', 0x2f, 'shift', 'Lock', 'altgr'],
  ...
  // evdev scancode 0x30 xkb keycode 56 xkb keyname AB05  level 2 keysym 0x42
  //['B', 0x30, 'Lock'],
  // evdev scancode 0x30 xkb keycode 56 xkb keyname AB05  level 3 keysym 0xad2
  ['leftdoublequotemark', 0x30, 'altgr'],
  // evdev scancode 0x30 xkb keycode 56 xkb keyname AB05  level 3 keysym 0xad2
  //['leftdoublequotemark', 0x30, 'Lock', 'altgr'],
  // evdev scancode 0x30 xkb keycode 56 xkb keyname AB05  level 4 keysym 0xad0
  ['leftsinglequotemark', 0x30, 'shift', 'altgr'],
  // evdev scancode 0x30 xkb keycode 56 xkb keyname AB05  level 4 keysym 0xad0
  //['leftsinglequotemark', 0x30, 'shift', 'Lock', 'altgr'],
  ...
  // evdev scancode 0x31 xkb keycode 57 xkb keyname AB06  level 2 keysym 0x4e
  //['N', 0x31, 'Lock'],
  // evdev scancode 0x31 xkb keycode 57 xkb keyname AB06  level 3 keysym 0xad3
  ['rightdoublequotemark', 0x31, 'altgr'],
  // evdev scancode 0x31 xkb keycode 57 xkb keyname AB06  level 3 keysym 0xad3
  //['rightdoublequotemark', 0x31, 'Lock', 'altgr'],
  // evdev scancode 0x31 xkb keycode 57 xkb keyname AB06  level 4 keysym 0xad1
  ['rightsinglequotemark', 0x31, 'shift', 'altgr'],
  // evdev scancode 0x31 xkb keycode 57 xkb keyname AB06  level 4 keysym 0xad1
  //['rightsinglequotemark', 0x31, 'shift', 'Lock', 'altgr'],
  // evdev scancode 0x32 xkb keycode 58 xkb keyname AB07  level 1 keysym 0x2c
  ['comma', 0x32],
  // evdev scancode 0x32 xkb keycode 58 xkb keyname AB07  level 2 keysym 0x3f
  ['question', 0x32, 'shift'],
  // evdev scancode 0x32 xkb keycode 58 xkb keyname AB07  level 3 keysym 0xfe51
  ['dead_acute', 0x32, 'altgr'],
  // evdev scancode 0x32 xkb keycode 58 xkb keyname AB07  level 4 keysym 0xfe59
  ['dead_doubleacute', 0x32, 'shift', 'altgr'],
  // evdev scancode 0x33 xkb keycode 59 xkb keyname AB08  level 1 keysym 0x3b
  ['semicolon', 0x33],
  // evdev scancode 0x33 xkb keycode 59 xkb keyname AB08  level 2 keysym 0x2e
  ['period', 0x33, 'shift'],
  // evdev scancode 0x33 xkb keycode 59 xkb keyname AB08  level 3 keysym 0x1002022
  ['U2022', 0x33, 'altgr'],
  // evdev scancode 0x33 xkb keycode 59 xkb keyname AB08  level 4 keysym 0xd7
  ['multiply', 0x33, 'shift', 'altgr'],
  // evdev scancode 0x34 xkb keycode 60 xkb keyname AB09  level 1 keysym 0x3a
  ['colon', 0x34],
  // evdev scancode 0x34 xkb keycode 60 xkb keyname AB09  level 2 keysym 0x2f
  ['slash', 0x34, 'shift'],
  // evdev scancode 0x34 xkb keycode 60 xkb keyname AB09  level 3 keysym 0xb7
  ...
  // evdev scancode 0x35 xkb keycode 61 xkb keyname AB10  level 1 keysym 0x21
  ['exclam', 0x35],
  // evdev scancode 0x35 xkb keycode 61 xkb keyname AB10  level 2 keysym 0xa7
  ['section', 0x35, 'shift'],
  ...
  // evdev scancode 0x53 xkb keycode 91 xkb keyname KPDL  level 2 keysym 0xffae
  // ['KP_Decimal', 0x53, 'Mod2'],
